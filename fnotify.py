...
NOTE: This source code is not mine and was taken from online sources.
'''
...
class WindowsBalloonTip:
    def __init__(self, title, msg):
        ...
        #This unregisters the class so that more messages can be shown
